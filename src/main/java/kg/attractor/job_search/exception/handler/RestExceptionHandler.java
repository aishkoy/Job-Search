...
public class RestExceptionHandler {
    ...
    @ExceptionHandler(IncorrectCategoryException.class)
    public ResponseEntity<ErrorResponseBody> handleIncorrectCategory(IncorrectCategoryException e) {
        log.error("REST API Error - IncorrectCategoryException: {}", e.getMessage());
        return new ResponseEntity<>(errorService.makeResponse(e), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(AlreadyRespondedException.class)
    public ResponseEntity<ErrorResponseBody> handleAlreadyResponded(AlreadyRespondedException e) {
        log.error("REST API Error - AlreadyRespondedException: {}", e.getMessage());
        return new ResponseEntity<>(errorService.makeResponse(e), HttpStatus.BAD_REQUEST);
    }
}
